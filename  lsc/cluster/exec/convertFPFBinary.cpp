...
int main(int argc, char** argv) {
  ...
  string basePathname(ans[0]); basePathname=basePathname+"/"+projectName+"/";
  ...
  if(argc!=4) {
    fprintf(stderr, "Usage: convertBinary project morganDataFolder fpVersion\n");
    exit(-1); 
  }
  ...
  string jCMapperFilename=morganDataPathname+fpVersionName+".fpf";
  ...
  printf("morganDataFolder: %30s\n", morganDataFoldername.c_str());
